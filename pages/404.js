...
import LinearButtonComponent from './../src/components/LinearButtonComponent/LinearButtonComponent';
          ...
          <Row>
            <Col lg={6} md={12}>
              <div className={styles.container}>
                ...
                <LinearButtonComponent title={"Go to Home"} onClick={()=> onClick()} isLoading={loading}/>
              </div>
            </Col>
