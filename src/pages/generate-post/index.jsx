...
const GeneratePost = () => {
  ...
  return (
    <div className="mx-auto max-w-3xl text-white p-6 relative">
      <h1 className="text-2xl font-bold mb-4">Generate Your Post</h1>

      <textarea
        className="w-full h-32 p-3 border border-border-dark bg-surface-dark text-white rounded"
      ...
      <Button
        className={`btn-secondary text-sm mt-3 px-4 py-1.5 rounded-md border border-primary ${
          loading ? "opacity-50 cursor-not-allowed" : "hover:bg-surface-medium"
        }`}
