...
const RegisterPage = () => {
  ...
  const validate = () => {
    ...
    if (!form.password) newErrors.password = 'Password is required';
      ...
      newErrors.password = 'Password must be at least 6 characters and include letters, numbers, and a special character';
          ...
          <div className="w-full max-w-md space-y-8 z-10">
            <div className="text-center mb-4">
              ...
              <p className="text-text-secondary text-base">
                Join <span className="bg-gradient-to-r from-primary to-neon-purple bg-clip-text text-transparent font-bold">SocialLens</span> and start your journey
              </p>
            </div>
