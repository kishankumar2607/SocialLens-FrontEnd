...
import { FaInstagramSquare, FaUnlink, FaPlug } from "react-icons/fa";

const InstagramAccount = ({ setLoading }) => {
    ...
    >
      ...
      {isConnected ? (
        <div className="flex items-center gap-2 mb-3 mt-3">
          ...
          <span className="text-pink-500 font-semibold text-lg capitalize">
            {userName}
          </span>
        </div>
      ) : (
      ...
      {isConnected ? (
        <button
          ...
          onClick={() => console.log("Disconnect Instagram Account")}
        >
        ...
        <button
          ...
          onClick={() => console.log("Connect Instagram Account")}
        >
