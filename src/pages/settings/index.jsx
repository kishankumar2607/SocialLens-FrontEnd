    ...
    <div className="relative min-h-screen bg-background-dark text-white px-6 py-12">
      ...
      <div className="max-w-4xl mx-auto relative z-10 space-y-10">
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-neon-purple flex items-center justify-center text-xl font-bold">
            U
          </div>
          <div>
        ...
        <section className="bg-surface-dark rounded-xl p-6 border border-border-dark shadow space-y-4">
          ...
          <input type="text" placeholder="Full Name" className="input-default w-full" />
          <input type="email" placeholder="Email Address" className="input-default w-full" />
        ...
        <section className="bg-surface-dark rounded-xl p-6 border border-border-dark shadow space-y-4">
          ...
          <input type="password" placeholder="Current Password" className="input-default w-full" />
          <input type="password" placeholder="New Password" className="input-default w-full" />
          <input type="password" placeholder="Confirm New Password" className="input-default w-full" />
