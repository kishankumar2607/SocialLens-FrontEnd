  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-900 text-gray-100">
      <section className="relative flex flex-col justify-center items-center text-center flex-1 px-6 py-20">
        <div className="max-w-3xl space-y-6">
          ...
          <p className="text-lg text-gray-300">
            Get real-time analytics, easy engagement tools, and AI-powered insights—completely free for 30 days.
          </p>
        ...
        {/* <img
          ...
          alt="SocialLens Dashboard"
          className="mt-10 w-full max-w-4xl rounded-lg shadow-2xl"
        /> */}
      </section>
          ...
          <div className="divide-y divide-slate-700">
            <div className="grid grid-cols-3 items-start p-6">
              <div>
                ...
                <p className="mt-1 text-gray-400">Lightning-fast setup with zero training</p>
              </div>
              <div>
                <p className="font-medium text-white">Instant Insights</p>
                <p className="mt-1 text-gray-400">See your first report in under 5 minutes</p>
              </div>
              <div>
                <p className="font-medium text-white">95%+</p>
                <p className="mt-1 text-gray-400">Of customers report clear ROI within one day</p>
              </div>
            </div>
            <div className="grid grid-cols-3 items-start p-6">
              <div>
                <p className="font-medium text-white">Support</p>
                <p className="mt-1 text-gray-400">24/7 live chat, email, and phone</p>
              </div>
              <div>
                <p className="font-medium text-white">Strategic Focus</p>
                <p className="mt-1 text-gray-400">Spend less time troubleshooting</p>
              </div>
              <div>
                <p className="font-medium text-white">80%+</p>
                <p className="mt-1 text-gray-400">Of power users expand within 30 days</p>
              </div>
            </div>
            <div className="grid grid-cols-3 items-start p-6">
              <div>
                <p className="font-medium text-white">Innovation</p>
                <p className="mt-1 text-gray-400">AI-powered social listening built-in</p>
              </div>
              <div>
                <p className="font-medium text-white">Streamlined Workflow</p>
                <p className="mt-1 text-gray-400">Automate manual tasks with a single click</p>
              </div>
              <div>
                <p className="font-medium text-white">200%</p>
                <p className="mt-1 text-gray-400">Average uplift in team efficiency</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto text-center space-y-12">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            ...
            <div className="flex flex-col items-center bg-slate-800 rounded-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">AI-Powered Listening</h3>
              <p className="text-gray-400 text-center">
            ...
            <div className="flex flex-col items-center bg-slate-800 rounded-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-semibold text-white mb-2">Smart Publishing</h3>
              <p className="text-gray-400 text-center">
      ...
      <section className="py-16 px-6 bg-slate-950">
        <div className="max-w-5xl mx-auto text-center space-y-12">
          <h2 className="text-4xl font-bold text-white">Achieve More with Add-Ons</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-slate-800 rounded-lg p-6 hover:shadow-lg transition-shadow">
              <h3 className="font-semibold text-xl text-green-400 mb-2">Advanced Listening</h3>
              <p className="text-gray-300">
                Harness the power of global conversations to spot trends early and respond faster.
              </p>
              <a href="/features/listening" className="mt-4 inline-block text-green-400 hover:underline">
                Learn more →
              </a>
            </div>
            <div className="bg-slate-800 rounded-lg p-6 hover:shadow-lg transition-shadow">
              <h3 className="font-semibold text-xl text-green-400 mb-2">Advocacy Tools</h3>
              <p className="text-gray-300">
                Mobilize your internal teams to share brand stories at scale with one click.
              </p>
              <a href="/features/advocacy" className="mt-4 inline-block text-green-400 hover:underline">
                Learn more →
              </a>
            </div>
            <div className="bg-slate-800 rounded-lg p-6 hover:shadow-lg transition-shadow">
              <h3 className="font-semibold text-xl text-green-400 mb-2">Partnerships & Integrations</h3>
              <p className="text-gray-300">
                Connect SocialLens with Salesforce, Slack, and your favorite tools—so data flows seamlessly.
              </p>
              <a href="/features/integrations" className="mt-4 inline-block text-green-400 hover:underline">
                Learn more →
              </a>
            </div>
          </div>
        ...
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="space-y-4">
            ...
            <details className="bg-slate-800 rounded-lg p-4">
              ...
              <p className="mt-2 text-gray-300">
                No. We never ask for a credit card during your 30-day free trial.
              </p>
            </details>
          </div>
        </div>
