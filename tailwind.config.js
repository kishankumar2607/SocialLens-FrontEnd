module.exports = {
  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        'gradient-primary': 'linear-gradient(to right, var(--color-primary), var(--color-primary-hover))',
        'gradient-neon': 'linear-gradient(to right, var(--color-neon-blue), var(--color-neon-purple))',
      },
    },
  },
  plugins: [
